...
def get_all_hotSong():  # 获取热歌榜所有歌曲名称和id
    ...
    # urllib 是Python标准库中用于网络请求的库。有四个模块: urllib.request、urllib.error、urllib.parse、urllib.robotparse
...
def get_hotComments(hot_song_name, hot_song_id):
    ...
    num = 0
    fhandle = open('./song_comments.txt', 'a')  # 写入文件
